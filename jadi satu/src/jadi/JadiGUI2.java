 ...
 * @author Priyo
 */
public class JadiGUI2 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JadiGUI2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
